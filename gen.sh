...
do
  ...
  \"textures\": {\n\
    \"particle\": \"betterend:block/${name}_front\",\n\
    \"north\": \"betterend:block/${name}_front\",\n\
    \"south\": \"betterend:block/${name}_side\",\n\
    \"east\": \"betterend:block/${name}_side\",\n\
    \"west\": \"betterend:block/${name}_front\",\n\
    \"up\": \"betterend:block/${name}_top\",\n\
    \"down\": \"betterend:block/${textureName}\"\n\
  }\n\
}" > ResourcePack/assets/betterend/models/block/${name}.json
	printf "{\n\
  \"parent\": \"betterend:block/${name}\"\n\
}" > ResourcePack/assets/betterend/models/item/${name}.json
done <./ItemLists/Crafting.txt